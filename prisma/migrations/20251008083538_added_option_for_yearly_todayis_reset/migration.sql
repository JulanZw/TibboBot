...
INSERT INTO "new_Guild" ("allowBackups", "birthdayChannelId", "countChannelId", "countNumber", "dumbScore", "guildId", "highestNumber", "lastCountUser", "pointGiverId", "todayIsChannelId") SELECT "allowBackups", "birthdayChannelId", "countChannelId", "countNumber", "dumbScore", "guildId", "highestNumber", "lastCountUser", "pointGiverId", "todayIsChannelId" FROM "Guild";
DROP TABLE "Guild";
