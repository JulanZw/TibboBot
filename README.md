...
It also uses my [bot framework](https://github.com/JulanZw/TToolbox)
...
› todayis_reset - Toggles whether the today-is stats reset yearly or not for this server.
...
› backup - Makes a backup of a channel.
